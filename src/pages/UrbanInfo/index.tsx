...
function UrbanInfoDashboard() {
    ...
    const greenBeltAcres = useMemo(() => {
        return Math.floor(dp.features.reduce((accumulator, currentValue) => accumulator + currentValue.properties.AREA_HA, 0))
    }, []);
    ...
    return (
        <div className={styles.urbanContainer}>
                    ...
                    <MapContainer center={[55.860916, -4.251433]} zoom={11.75}>
                        ...
                        <LayersControl>
                            <LayerGroup>
                                ...
                                <LayersControl.Overlay name={"Automated bycicle rental stations"}>
                                    <GeoJSON
                                        data={cycle}
                                        onEachFeature={myRandomFunc}
            ...
            <div className={styles.bottomSection}>
                ...
                <div className={styles.infoCard}>
                    <h2>There are {greenBeltAcres} acres of green belt areas around Glasgow</h2>
                </div>
                ...
                <div className={styles.chart}>
                    <PieChart
                        dataSource={values[0].sort(sortDays)}
                        palette="Material"
